...
function Research() {
  return <React.Fragment>
    ...
    <div className='research'>
      <div className='research_head'>Research Interests</div>
      <div className='research_content'>My research Areas include Machine Learning, Internet Of Things, Optical Networks</div>
    </div>
    <div className='research_papers'>
      <div className='research_head'>
        Research Papers
      </div>
      <div className='rpaper'>
       <div className='rtitle'>Hardware implementation of contention aware optical switching node for data center Networks [Jun 2019]</div>
      <div className='publ'><a href={'https://onlinelibrary.wiley.com/doi/10.1002/mop.31899'} target={'_blank'} rel="noreferrer"> Wiley Publication</a></div>
      <div className='paper_download'><a href={opt2} target={'_blank'}> Download Paper</a></div>
      </div>
      <div className='rpaper'>
      <div className='rtitle'> IoT Enabled Farming Assist and Security Using Machine Learning [May 2019]</div>
      <div className='publ'><a href={iot} target={'_blank'} rel="noreferrer"> ARPN Journal</a></div>
      <div className='paper_download'><a href={iot} target={'_blank'}> Download Paper</a></div>
      </div>
      <div className='rpaper'>
      <div className='rtitle'>Hardware implementation of optical switching node for data center networks [Nov 2018]</div>
      <div className='publ'><a href={'https://onlinelibrary.wiley.com/doi/10.1002/mop.31630'} target={'_blank'} rel="noreferrer"> Wiley Publication</a></div>
      <div className='paper_download'><a href={opt1} target={'_blank'}> Download Paper</a></div>
      </div>
      <div className='other_research'>
        ...
        <div className='project'>
         <div className='ptitle'>
          ...
          <div className='pcontent'>
           ...
           <li>Co-Authored the paper on the same in ETRIJ Publication and submitted it for publication, Manuscript ID etrij-2021-
            0182, Jun 2021 – Present.</li>
         </div>
        </div>
        <div className='project'>
         <div className='ptitle'>
