...
const Experience = () => {
  return <div>
      ...
      <div className='experience_box'>
       <div className='experience_head'>Professional Experience [ 3+ Years]</div>
       <div className='diff_box'>
         <div className='company_details'><div className='job_name'>Ericsson</div> <div className='job_date'>Jun 2021 to Present</div></div>
         <div className='company_team'> Developer - Cloud Container Distribution</div>
         <div className='company_work'>
          <li>- Managing and orchestrating all containerized applications deployed in Ericsson products using Kubernetes, Helm,
              and open stack heat deployments.</li>
       ...
       <div className='diff_box'>
         <div className='company_details'><div className='job_name'>Blackrock</div> <div className='job_date'>Jul-2019 to Jun-2021</div></div>
         <div className='company_team'>Analyst - Data & AI</div>
         <div className='company_work'>
       ...
       <div className='diff_box'>
         <div className='company_details'><div className='job_name'>Blackrock</div> <div className='job_date'>Jan-2019 to Jul-2019</div></div>
         <div className='company_team'>Technology Intern - Data & AI</div>
         <div className='company_work'>
       ...
       <div className='diff_box'>
         <div className='company_details'><div className='job_name'>Nokia Solutions</div> <div className='job_date'>May-2018 to Jul-2018</div></div>
         <div className='company_team'>Intern - Technology Team</div>
         <div className='company_work'>
       ...
       <div className='diff_box'>
         <div className='company_details'><div className='job_name'>VIT University</div> <div className='job_date'>Jun-2017 to Nov-2017</div></div>
         <div className='company_team'>Teaching Assistant - Data Structures and Algorithms</div>
         <div className='company_work'>
